/*
  ...
  - You are about to drop the `Gam` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Gues` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Participan` table. If the table is not empty, all the data it contains will be lost.
